...
- Files with plot centroids (various shapefiles, mostly of ESRI format)

She has a paper to write based on this data - but first of all she has to see what she has to work with. 
